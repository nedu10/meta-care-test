...
var client = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, redis_2.createClient)("redis://" + redis_1.default.url, {
                        password: redis_1.default.password
                    })];
            case 1:
                client_1 = _a.sent();
                client_1.on("connect", function () {
                    logger_1.default.info("Client connected to redis...");
                });
                client_1.on("ready", function () {
                    logger_1.default.info(" Client connected to redis and ready to use... 🔥");
                });
                ...
                exports.redisClient = redisClient = client_1;
                return [2 /*return*/, client_1];
            case 2:
                error_1 = _a.sent();
                console.log(error_1);
                return [2 /*return*/, console.log("fail to connect to the db")];
